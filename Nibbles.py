...
# -*- coding: utf-8 -*-
########################################################################################################################
# Joe's Python Experimente - Nibbles Game
#-----------------------------------------------------------------------------------------------------------------------
# \file       Nibbles.py
# \creation   2015-03-04, Joe Merten
#-----------------------------------------------------------------------------------------------------------------------
# Based upon: Jan Bodnar, ZetCode Tkinter tutorial, http://zetcode.com/gui/tkinter/nibbles
# Prerequisites: sudo apt-get install python-imaging-tk
########################################################################################################################
...
class Board(Canvas):
    ...
    def initGame(self):
        ...
        try:
            self.dot   = ImageTk.PhotoImage(Image.open("NibblesTail.png"))
            self.head  = ImageTk.PhotoImage(Image.open("NibblesHead.png"))
            self.apple = ImageTk.PhotoImage(Image.open("NibblesApple.png"))
    ...
    def onKeyPressed(self, e):
        ...
        if key == "Return" and not self.inGame:
            self.delete(ALL)
            self.initGame()
